...
function renderExperience() {
    ...
    container.innerHTML = portfolioData.experience.map(function(exp, i) {
        return '<div class="timeline-item">' +
            ...
            '<div><h3 class="card-title" style="margin-bottom:0.1rem">' + exp.title + '</h3>' +
            '<p class="card-subtitle">' + exp.company + '</p></div></div>' +
            '<p style="font-size:0.8rem;' + ac + ';display:flex;align-items:center;gap:0.35rem;margin-bottom:0.2rem">' +
            '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>' + exp.date + '</p>' +
            '<p style="font-size:0.8rem;' + ac + ';display:flex;align-items:center;gap:0.35rem;margin-bottom:0.75rem">' +
            '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>' + exp.location + '</p>' +
